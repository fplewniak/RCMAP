...
class MyTestCase(unittest.TestCase):
    ...
    def test_read_alignments(self):
        (seqref, seqeval) = Alignments().read_alignments("data/ArsM_aln.faa", ["Q969Z2", "WP_045226361.1"])
    ...
    def test_get_cat_at_pos(self):
        seqrefs = Alignments().read_alignments("data/ArsM_aln.faa", ["Q969Z2", "WP_045226361.1"])[0]
        assert Alignments().get_cat_at_pos(3) == {'T'}
